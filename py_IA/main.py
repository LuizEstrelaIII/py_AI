...
# só não aplica na coluna de score_credito 
...
# y é a coluna que o modelo calcule
# x vai todas as colunas que vai ser usada para prever o score de credito, não usa a coluna id_cliente porque ela é um numero qualquer que nao ajuda a previsao
